...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // Get current width to decide on single plant vs graden grid view
     ...
     */
    private static RemoteViews getSinglePlantRemoteView
            (Context context, int imgRes, long plantId, boolean showWater) {
    ...
    private static RemoteViews getGardenGridRemoteView(Context context) {
        ...
        // Set the GridWidgetService intent to act as the adapter for teh GridView
